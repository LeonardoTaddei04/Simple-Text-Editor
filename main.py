...
class Menubar:
    ...
    def __init__(self, parent):
        font_specs = ('Segoe UI Variable', 14)
        ...
        about_dropdown.add_command(label="Check For Updates ...",
    ...
    def show_about_message(self):
        box_title = "About"
        box_message = "The code is on github for those interested in the technical functioning of this app."
        messagebox.showinfo(box_title, box_message)

    def show_release_notes(self):
        box_title = "Check For Updates ..."
        box_message = "There are currently no updates available"
        messagebox.showinfo(box_title, box_message)
...
class Statusbar:
    ...
    def __init__(self, parent):
        ...
        self.status.set("Simple Text Editor")
...
class PyText:
    ...
    def __init__(self, master):
        master.title("Untitled - Simple Text Editor")
    ...
    def set_window_title(self, name=None):
        if name:
            self.master.title(name + " - Simple Text Editor")
        else:
            self.master.title("Untitled - Simple Text Editor")
